                ...
                <?php else: ?>
                    <?php foreach ($data as $item): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                <?php if ($item['l_type'] == LocationModel::TYPE_CONSTRUCTION_SITE): ?>
                                    <a href="<?= url_to('LocationController::materialUsage', $item['l_id']) ?>" class="btn btn-sm btn-outline-secondary me-1" title="用料情況">
